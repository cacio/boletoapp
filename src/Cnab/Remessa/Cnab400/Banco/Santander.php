...
namespace Boletos\Cnab\Remessa\Cnab400\Banco;

use Boletos\Util;
use Boletos\CalculoDV;
use Boletos\Exception\ValidationException;
use Boletos\Cnab\Remessa\Cnab400\AbstractRemessa;
use Boletos\Contracts\Boleto\Boleto as BoletoContract;
use Boletos\Contracts\Cnab\Remessa as RemessaContract;
...
class Santander extends AbstractRemessa implements RemessaContract
{
    ...
    /**
     * @param \Boletos\Boleto\Banco\Santander $boleto
     *
     * @return Santander
     * @throws ValidationException
     */
