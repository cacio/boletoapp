...
$boleto = new Boletos\Boleto\Banco\Itau([
    ...
    'qr_code_style'          => Boletos\Boleto\Banco\Itau::QRCODE_ESTILO_PONTO,
]);

$pdf = new Boletos\Boleto\Render\Pdf();
$pdf->addBoleto($boleto);
$pdf->setLocalizacaoPix(Boletos\Boleto\Render\Pdf::PIX_INSTRUCAO);
//$pdf->setLocalizacaoPix(Boletos\Boleto\Render\Pdf::PIX_COD_BARRAS);
